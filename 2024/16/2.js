...
const playersWithMinCost = finishedPlayers.filter(player => player.moveCost === result);

const allSeats = playersWithMinCost.reduce((acc, player) => {
...
console.log('allSeats: ', allSeats.size + 1);
        ...
        const newPlayers = moves.reduce((acc, move) => {
            ...
            switch (move.action) {
                case 'move':
                    ...
                    newPlayer.moves.push(`${newPlayer.currentPosition[0]}_${newPlayer.currentPosition[1]}`);
