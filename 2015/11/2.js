...
const nextValidPass = getNextValidPass(data);

console.log('MY_REG nextValidPass: ', nextValidPass);

const nextValidPass2 = getNextValidPass(nextValidPass);

console.log('MY_REG RESULT nextValidPass2: ', nextValidPass2);

function getNextValidPass(pass) {
    let nextPass = pass;
    while (true) {
